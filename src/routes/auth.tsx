        ...
        <div className="bg-card/80 backdrop-blur-xl border border-border rounded-2xl shadow-2xl p-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="space-y-6">
            <form onSubmit={submit} className="space-y-4">
              ...
              >
                {emailLoading ? <Loader2 className="h-5 w-5 animate-spin" /> : null}
            ...
            <button 
              ...
              disabled={anyLoading}
              className="w-full h-12 rounded-xl border border-border bg-white text-black font-semibold hover:bg-gray-100 disabled:opacity-60 inline-flex items-center justify-center gap-3 transition-all"
            >
              {googleLoading ? <Loader2 className="h-5 w-5 animate-spin text-black" /> : (
